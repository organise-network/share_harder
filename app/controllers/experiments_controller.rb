class ExperimentsController < ApplicationController
  ...
  def experiment_params
    raw_params = params.require(:experiment).permit(:id, :name, :url, variants: [:id, :title, :description, :share_text, :_destroy, template_image: [:id, :url, :height, :width, { overlays: [:text, :top, :left, :size, :color, :font, :textStrokeWidth, :textStrokeColor, :align, :rotation] } ] ])
